  ...
  return (
    <section id="kontak" className="scroll-mt-24 bg-white py-16 sm:py-24 lg:py-28">
      <div className="section-shell">
        <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-navy-950 via-navy-900 to-blue-700 p-6 text-white shadow-premium sm:p-10 lg:p-14">
          ...
          <div>
              ...
              <h2 className="mt-4 max-w-4xl text-3xl font-extrabold tracking-[-0.03em] sm:text-5xl">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                {benefits.map((benefit) => (
                  <span
                    key={benefit}
                    className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-sm font-bold text-white"
                  >
            ...
            <div className="rounded-[1.5rem] border border-white/15 bg-white/10 p-5 backdrop-blur">
              ...
              <p className="mt-3 text-2xl font-extrabold">Ceritakan usaha kamu, saya bantu susun arah websitenya.</p>
