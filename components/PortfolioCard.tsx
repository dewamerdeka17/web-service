...
export function PortfolioCard({ project }: PortfolioCardProps) {
  ...
  return (
    <article className="group rounded-[1.75rem] border border-slate-200 bg-white p-4 shadow-soft transition duration-300 hover:-translate-y-1.5 hover:border-blue-200 hover:shadow-premium">
      ...
      <div className="mt-6 px-1 pb-1">
        ...
        <h3 className="mt-4 text-2xl font-extrabold tracking-[-0.02em] text-navy-950">{project.name}</h3>
